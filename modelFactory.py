...
from utility.QueryRewriter import rewriteAbbrInQuery, combineQueryRewriters, rewriteStopWords
...
def getModelWithAbbrQrStopsQrAndSpeller():
    nlp = model_lg.load()
    intentSet = getIntentSet()
    return CliNlpModel("lgd_lgm_abbrQrStopsQrAndSpeller", intentSet, nlp,
                       rewriteDataQuery=combineQueryRewriters([rewriteAbbrInQuery, rewriteStopWords]),
                       rewriteUserQuery=combineQueryRewriters([rewriteAbbrInQuery, rewriteStopWords, correctSpellingErrors]))
